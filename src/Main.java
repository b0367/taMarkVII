...
public class Main {
    ...
    public static void initialize2() {
        Room[] line = new Room[]{new Room(new Item[]{ new Item("A1", "Red_key", "A small key painted red.", "Smells Like Paint", "Tastes like paint", "Doesn't sound like much.", "a", "a", false, true, true, false, false, false), new Item("A2", "Blue_Key", "A blue key.", "A small hint of paint is smelled.", "Tastes faintly like iron.", "You hear nothing from the key.", "a", "a", false, true, true, false, false, false)
